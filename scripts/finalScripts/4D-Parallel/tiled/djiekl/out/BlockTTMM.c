...
void BlockTTMM(long n, long b, float**** A, float**** B, float**** C){
	...
	#define S1(i,j,k,l,i4,i5) C(k,j,i4,i5) = 0
	#define S0(i,j,k,l,d,e) C(k,j,d,e) = (C(k,j,d,e))+((A(k,i,d,l))*(B(i,j,l,e)))
	{
		//Domain
		//{i,j,k,l,i4,i5|l==0 && i==0 && n>=1 && b>=1 && k>=0 && j>=k && n>=j+1 && i4>=0 && b>=i4+1 && i5>=0 && b>=i5+1}
