...
void BlockTTMM(long n, long b, float**** A, float**** B, float**** C){
	...
	#define S1(i,j,k,l,i4,i5) C(i,k,l,i5) = 0
	#define S0(i,j,k,l,d,e) C(i,k,l,e) = (C(i,k,l,e))+((A(i,j,l,d))*(B(j,k,d,e)))
	{
		//Domain
		//{i,j,k,l,i4,i5|i4==0 && j==0 && n>=1 && b>=1 && i>=0 && k>=i && n>=k+1 && l>=0 && b>=l+1 && i5>=0 && b>=i5+1}
		//{i,j,k,l,d,e|i>=0 && j>=i && n>=j+1 && l>=0 && b>=l+1 && d>=0 && b>=d+1 && n>=1 && b>=1 && j>=0 && k>=j && n>=k+1 && b>=e+1 && e>=0 && k>=i}
