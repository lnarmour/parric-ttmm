...
do
    ...
    make "CFLAGS=-O3  -std=c99  -I/usr/include/malloc/  -xhost -ipo -fma -fopenmp -DPARALLEL_D=1 -I/s/parsons/l/sys/intel/mkl/include/ -L/s/parsons/l/sys/intel/compilers_and_libraries_2019.3.199/linux/mkl/lib/intel64  -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core  -L/s/parsons/l/sys/intel/lib/intel64 -liomp5 -lm"  &> /dev/null;
