...
void BlockTTMM(long n, long b, float**** A, float**** B, float**** C){
	...
	#define S1(i,j,k,l,i4,i5) C(k,i,l,i5) = 0
	#define S0(i,j,k,l,d,e) C(k,i,l,e) = (C(k,i,l,e))+((A(k,j,l,d))*(B(j,i,d,e)))
	{
		//Domain
		//{i,j,k,l,i4,i5|i4==0 && j==0 && n>=1 && b>=1 && k>=0 && i>=k && n>=i+1 && l>=0 && b>=l+1 && i5>=0 && b>=i5+1}
		//{i,j,k,l,d,e|k>=0 && j>=k && n>=j+1 && l>=0 && b>=l+1 && d>=0 && b>=d+1 && n>=1 && b>=1 && j>=0 && i>=j && n>=i+1 && b>=e+1 && e>=0 && i>=k}
