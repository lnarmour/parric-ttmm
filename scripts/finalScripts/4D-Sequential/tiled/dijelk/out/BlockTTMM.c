...
void BlockTTMM(long n, long b, float**** A, float**** B, float**** C){
	...
	#define S1(i,j,k,l,i4,i5) C(j,k,i5,i4) = 0
	#define S0(i,j,k,l,d,e) C(j,k,e,d) = (C(j,k,e,d))+((A(j,i,e,l))*(B(i,k,l,d)))
	{
		//Domain
		//{i,j,k,l,i4,i5|l==0 && i==0 && n>=1 && b>=1 && j>=0 && k>=j && n>=k+1 && i5>=0 && b>=i5+1 && i4>=0 && b>=i4+1}
		//{i,j,k,l,d,e|j>=0 && i>=j && n>=i+1 && e>=0 && b>=e+1 && l>=0 && b>=l+1 && n>=1 && b>=1 && i>=0 && k>=i && n>=k+1 && b>=d+1 && d>=0 && k>=j}
