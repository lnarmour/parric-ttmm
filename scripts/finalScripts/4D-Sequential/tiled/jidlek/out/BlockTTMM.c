...
void BlockTTMM(long n, long b, float**** A, float**** B, float**** C){
	...
	#define S1(i,j,k,l,i4,i5) C(j,i,i5,l) = 0
	#define S0(i,j,k,l,d,e) C(j,i,e,l) = (C(j,i,e,l))+((A(j,k,e,d))*(B(k,i,d,l)))
	{
		//Domain
		//{i,j,k,l,i4,i5|i4==0 && k==0 && n>=1 && b>=1 && j>=0 && i>=j && n>=i+1 && i5>=0 && b>=i5+1 && l>=0 && b>=l+1}
		//{i,j,k,l,d,e|j>=0 && k>=j && n>=k+1 && e>=0 && b>=e+1 && d>=0 && b>=d+1 && n>=1 && b>=1 && k>=0 && i>=k && n>=i+1 && b>=l+1 && l>=0 && i>=j}
