...
void BlockTTMM(long n, long b, float**** A, float**** B, float**** C){
	...
	#define S1(i,j,k,l,i4,i5) C(i,j,i5,i4) = 0
	#define S0(i,j,k,l,d,e) C(i,j,e,d) = (C(i,j,e,d))+((A(i,k,e,l))*(B(k,j,l,d)))
	{
		//Domain
		//{i,j,k,l,i4,i5|l==0 && k==0 && n>=1 && b>=1 && i>=0 && j>=i && n>=j+1 && i5>=0 && b>=i5+1 && i4>=0 && b>=i4+1}
		//{i,j,k,l,d,e|i>=0 && k>=i && n>=k+1 && e>=0 && b>=e+1 && l>=0 && b>=l+1 && n>=1 && b>=1 && k>=0 && j>=k && n>=j+1 && b>=d+1 && d>=0 && j>=i}
