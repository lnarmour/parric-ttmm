...
void BlockTTMM(long n, long b, float**** A, float**** B, float**** C){
	...
	{
		//Domain
		//{i,j,k,l,i4,i5|l==0 && i==0 && n>=1 && b>=1 && k>=0 && n>=k+1 && j>=0 && n>=j+1 && i4>=0 && b>=i4+1 && i5>=0 && b>=i5+1}
		//{i,j,k,l,d,e|i>=0 && n>=i+1 && j>=0 && n>=j+1 && d>=0 && b>=d+1 && l>=0 && b>=l+1 && n>=1 && b>=1 && k>=0 && n>=k+1 && b>=e+1 && e>=0}
